...
PPP_AR INTEGER_COMPLEMENT_DIAGNOSTIC stage1_rows=1 remaining_coordinates=3 stage2_probe_rows=1 combined_independent_rows=2 target_integer_rank=4 stage2_status=RESOLVED_RATIO_ACCEPTED stage2_success_rate=0.99995 stage2_minimum_decorrelated=1 stage2_selected_decorrelated=3 stage2_integer_candidates=2 stage2_best_squared_norm=0.1 stage2_second_squared_norm=0.5 stage2_ratio=5 action=PROBE_ONLY_NOT_SUBMITTED
...
PPP_AR INTEGER_COMPLEMENT_DIAGNOSTIC stage1_rows=1 remaining_coordinates=3 stage2_probe_rows=0 combined_independent_rows=1 target_integer_rank=4 stage2_status=INSUFFICIENT_DECORRELATED_AMBIGUITIES stage2_success_rate=0.99996 stage2_minimum_decorrelated=3 stage2_selected_decorrelated=2 stage2_integer_candidates=0 stage2_best_squared_norm=-1 stage2_second_squared_norm=-1 stage2_ratio=-1 action=PROBE_ONLY_NOT_SUBMITTED
      Applying:  +1 A(SOFI,G02,L1C) -1 A(SOFI,G01,L1C) = +4.00000
"""
