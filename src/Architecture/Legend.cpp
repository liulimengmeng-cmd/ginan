...
{
	DOCS_REFERENCE(Architectural_Concept__);
	DOCS_REFERENCE(Parallel_Architecture__);
	DOCS_REFERENCE(Library__);
	DOCS_REFERENCE(FileType__);
	DOCS_REFERENCE(Input__);
	DOCS_REFERENCE(Output__);
	DOCS_REFERENCE(Database__);
	DOCS_REFERENCE(Code_Implementation__);
}
