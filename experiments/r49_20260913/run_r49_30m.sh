#!/usr/bin/env bash
set -Eeuo pipefail
audit=/mnt/c/Users/rx/Documents/GINAN/r49_work_20260913
data=/mnt/d/GINAN_R20/inputData
frozen=/home/rx/GINAN/frozen-r49-condition-domain-20260913
case_name=zhang_p3_exp3_G3_r49_condition_domain_2024199_180_003000_20260913
...
[[ ! -e /mnt/d/GINAN_R20/r49_root_snapshots_20260913 && ! -e "$output" && ! -e "$log" && ! -e "$state" && ! -e /mnt/d/GINAN_R20/r49_checkpoints_20260913 ]] || exit 89
cd "$frozen"
...
export ZHANG_R49_SNAPSHOT_DIRECTORY=/mnt/d/GINAN_R20/r49_root_snapshots_20260913
