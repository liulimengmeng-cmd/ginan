...
checkpoint='/mnt/d/GINAN_R20/r50_checkpoint_smoke_20260914'+suffix
...
with (a/'smoke.log').open('w') as f:
 rc=subprocess.run(cmd,cwd='/mnt/d/GINAN_R20/inputData',env={**os.environ,'OPENBLAS_NUM_THREADS':'1','OMP_NUM_THREADS':'4','MKL_NUM_THREADS':'1','ZHANG_R50_RATIO_ONLY':'1','ZHANG_R49_FUSION_WEIGHT':'0.10','ZHANG_R49_SNAPSHOT_DIRECTORY':checkpoint+'_root_snapshots'},stdout=f,stderr=subprocess.STDOUT).returncode
